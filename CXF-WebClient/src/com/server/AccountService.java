...
public class AccountService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/CXF-Service/services/AccountPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/CXF-Service/services/AccountPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
    ...
    public AccountSEI getAccountPort() {
        return super.getPort(AccountPort, AccountSEI.class);
    }
     ...
     */
    @WebEndpoint(name = "AccountPort")
    public AccountSEI getAccountPort(WebServiceFeature... features) {
        return super.getPort(AccountPort, AccountSEI.class, features);
    }
