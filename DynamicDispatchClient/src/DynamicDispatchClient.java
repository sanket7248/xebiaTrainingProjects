...
public class DynamicDispatchClient {
	public static void main(String[] args) throws MalformedURLException {
		...
		String endpointAddress = "http://localhost:8080/CXF-Service/services/AccountPort"; // web
																							// service
																							// url
		...
		String xmlMessage = "<?xml version=\"1.0\" ?><S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\"><S:Body><ns2:getName xmlns:ns2=\"http://server.com/\"><arg0>1111</arg0></ns2:getName></S:Body></S:Envelope>";
