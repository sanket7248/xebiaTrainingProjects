...
public class BankServiceLocator extends org.apache.axis.client.Service implements com.bank.BankService {
    ...
    private java.lang.String Bank_address = "http://localhost:8082/Banking/services/Bank";
    ...
    public com.bank.BankPort getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bank.BankSoapBindingStub _stub = new com.bank.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bank.BankPort.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bank.BankSoapBindingStub _stub = new com.bank.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank.com", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank.com", "Bank"));
        }
